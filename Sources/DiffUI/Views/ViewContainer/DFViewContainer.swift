...
open class DFViewContainer: UIView {
    ...
    var safeAreaInsetEdges: DFInsetEdges = .none { didSet { updateAccumulatedInsets() } }
    ...
    public init(with containedView: UIView, insets: UIEdgeInsets = .zero, safeAreaInsetEdges: DFInsetEdges = .none, alignment: Alignment = .stretch, backgroundColor: UIColor = .clear, hidesWhenContainedViewHides: Bool = true) {
    ...
    open func setupOverScroll(with scrollView: UIScrollView?, edges: DFInsetEdges) {
...
private extension DFViewContainer {
...
public extension DFViewContainer {
