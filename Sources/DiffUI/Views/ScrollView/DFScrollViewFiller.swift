...
public final class DFScrollViewFiller: UIView {
...
private extension DFScrollViewFiller {
    
    func handleUpdate() {
        guard let scrollView = scrollView, scrollView.isTracking == false else { return }
        let fillers: [DFScrollViewFiller] = scrollView.findAllChildren()
